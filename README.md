...
1. Atualizar o arquivo ```contador.py``` com o nome do Bucket criado nas linhas que contém ```gs://desafio-dataprocdio1/```.
1. Fazer o upload dos arquivos ```contador.py``` e ```livro.txt``` para o bucket criado (instruções abaixo)
    - https://cloud.google.com/storage/docs/uploading-objects

1. Utilizar o código em um cluster Dataproc, executando um Job do tipo PySpark chamando ```gs://desafio-dataprocdio1/contador.py```
